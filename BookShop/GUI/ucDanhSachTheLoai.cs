...
{
    public partial class ucDanhSachTheLoai : UserControl
    {
        private BookShopContext db = Helper.db;
        private int index = 0, index1 = 0;

        #region constructor
        public ucDanhSachTheLoai()
        {
            InitializeComponent();
            Helper.Reload();
        }
        ...
        private bool Check()
        {
            ...
            {
                MessageBox.Show("Tên của thể loại không được để trống", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
        ...
        private void LoadDgvTheLoai()
        {
            ...
            var listTheLoai = db.THELOAIs.ToList()
                           ...
                           .ToList();
            dgvTheLoaiMain.DataSource = listTheLoai.ToList()
            ...
            {
                index = index1;
                dgvTheLoai.FocusedRowHandle = index;
                dgvTheLoaiMain.Select();
            }
            catch
            {
        ...
        private void dgvTheLoai_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            {
                index1 = index;
                index = dgvTheLoai.FocusedRowHandle;
            }
            catch { }
        }
        #endregion
